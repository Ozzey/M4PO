...
def replace_vit_attn_with_flash_attn():
    if not FLASH_ATTN_AVAILABLE:
        warnings.warn("flash_attn is not installed; RADIO will use timm's standard attention.")
        return
    if not torch.cuda.is_available():
        warnings.warn("CUDA is unavailable; RADIO will use timm's standard attention.")
        return
